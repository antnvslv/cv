...
function openCSS() {
    ...
    popupText.innerHTML = 'Выучил вместе с HTML в 13 лет, но на очень поверхностном уровне. Застал времена, когда обучали табличной верстке, это было больно. В 2021-м изучил флексбоксы, гриды, анимации и переходы. Сейчас быстро верстаю как флекс, так и сетку.';
}
